...
class Favorites extends Component {
          ...
          {!this.state.explosion ? (
            <View>
              <AnimatedHeart
                ...
                style={[
                  styles.heart,
                  getTransformationAnimation(this.state.animations[6], -12, -17, '300deg'),
              ...
              <AnimatedHeart
                ...
                style={[
                  styles.heart,
                  getTransformationAnimation(this.state.animations[5], 5, -19, '250deg'),
                  { opacity: this.state.fadeAnim }
                ]}
              />
              <AnimatedHeart
                ...
                style={[
                  styles.heart,
                  getTransformationAnimation(this.state.animations[4], 17, -9, '210deg'),
                  { opacity: this.state.fadeAnim }
                ]}
              />
              <AnimatedHeart
                ...
                style={[
                  styles.heart,
                  getTransformationAnimation(this.state.animations[3], 17, 9, '150deg'),
                  { opacity: this.state.fadeAnim }
                ]}
              />
              <AnimatedHeart
                ...
                style={[
                  styles.heart,
                  getTransformationAnimation(this.state.animations[2], 5, 19, '110deg'),
                  { opacity: this.state.fadeAnim }
                ]}
              />
              <AnimatedHeart
                ...
                style={[
                  styles.heart,
                  getTransformationAnimation(this.state.animations[1], -12, 17, '60deg'),
                  { opacity: this.state.fadeAnim }
                ]}
              />
              <AnimatedHeart
                ...
                style={[
                  styles.heart,
                  getTransformationAnimation(this.state.animations[0], -21, 0, '0deg'),
                  { opacity: this.state.fadeAnim }
                ]}
              />
            </View>
  ...
  renderDisabled = () => <Icon
    name='favorite'
    color={this.state.bgDisabled}
  />

  render() {
    const {
      onPress, activeColor, color, primary, active, disabled
    } = this.props
    let favorite
