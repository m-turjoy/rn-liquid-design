...
describe('Header component', () => {
  describe('Renders correctly', () => {
    test('it renders default Header', () => {
      const tree = shallow(
        <Header searchOptions={searchOptions} searchProperty="text" />
      );
      expect(tree).toMatchSnapshot();
    });
    test('it renders with icons Header', () => {
      const tree = shallow(
        <Header searchOptions={searchOptions} searchProperty="text" withIcons />
      );
      expect(tree).toMatchSnapshot();
    });
    test('it renders with label Header', () => {
      const tree = shallow(
        <Header searchOptions={searchOptions} searchProperty="text" withLabel />
      );
      expect(tree).toMatchSnapshot();
    });
