...
import Svg, { G, Defs, Path, Rect, Ellipse } from "react-native-svg";
...
class Placeholder extends Component {
	render() {
		const { width, height, isSquare, isRectangular } = this.props;

		const renderIllustration = () => (
			<Svg width={width / 2} height={height / 2} viewBox="0 0 160 100">
				<G>
					<Ellipse
						cx="122.653"
						cy="30.494"
		...
		const renderRectangularIllustration = () => (
			<Svg width={width / 1.3} height={height / 1.5} viewBox="0 0 450 100">
				<G>
					<Ellipse
						cx="360.246"
						cy="68.319"
		...
		const renderSquare = () => (
			<PlaceholderWrapper>
				<Svg width={width} height={height} viewBox="0 0 300 300">
					<Defs>
						<Rect id="a" width={width} height={height} rx="6" />
					</Defs>
				...
				<SquareIllustrationWrapper top={width / 4} left={width / 4}>
					{renderIllustration()}
				</SquareIllustrationWrapper>
			</PlaceholderWrapper>
		);
		...
		const renderRectangular = () => (
			<PlaceholderWrapper>
				<Svg width={width} height={height} viewBox="0 0 300 150">
					<Defs>
						<Rect id="a" width="300" height="150" rx="6" />
					</Defs>
					<G fill="none" fill-rule="evenodd">
						<G fill="#F8F8FC">
				...
				<RectangularIllustrationWrapper top={width / 25} left={width / 8}>
