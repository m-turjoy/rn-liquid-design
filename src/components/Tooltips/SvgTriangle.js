...
const adjustTrianglePoints = (side) =>
...
const adjustLeftPosition = (side, positionX, iconWidth) =>
  ((side === 'bottom-left' ||
    ...
    side === 'top-left' ||
    side === 'top-right') &&
    positionX + iconWidth / 2 - 8) ||
  ((side === 'left-top' || side === 'left-bottom') && positionX - 11) ||
  ((side === 'right-top' || side === 'right-bottom') &&
    positionX + iconWidth + 3);
const SvgTriangle = ({
  modalRenderSide,
