...
import Svg, { Rect, Defs, LinearGradient, Stop, RadialGradient, Path, Circle, ClipPath } from 'react-native-svg'
...
class BoxShadow extends Component {
    render = () => {
      ...
      const {
        setting: {
          width = 0, height = 0, color = '#000', border = 0, radius = 0, opacity = 1, x, y, style = {}
        }, children
      } = this.props
