...
describe("Table component", () => {
	describe("Renders correctly", () => {
		test("it renders Default small Table", () => {
			const tree = shallow(
				<Table rowsData={rowsData} headersData={headersData} type="small" />
			);
			expect(tree).toMatchSnapshot();
		});
		test("it renders medium Table", () => {
			const tree = shallow(
				<Table rowsData={rowsData} headersData={headersData} type="medium" />
			);
			expect(tree).toMatchSnapshot();
		});
		test("it renders large Table", () => {
			const tree = shallow(
				<Table rowsData={rowsData} headersData={headersData} type="large" />
			);
			expect(tree).toMatchSnapshot();
		});
		...
		test("it renders Table with Images", () => {
			const tree = shallow(
				<Table rowsData={rowsData} headersData={headersData} type="image" />
			);
			expect(tree).toMatchSnapshot();
		});
	});
