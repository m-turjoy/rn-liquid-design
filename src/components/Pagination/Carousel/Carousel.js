...
import { defaultScrollInterpolator, defaultAnimatedStyles } from './animations';
...
export default class Carousel extends PureComponent {
  ...
  _getCenter(offset) {
    return offset + this._getViewportOffet();
  }
  ...
  _initPositionsAndInterpolators(props = this.props) {
    const { data, itemWidth, itemHeight, scrollInterpolator } = props;
