...
const CustomTick = (props) => {
  ...
  const tooltipData = (props.dataFormatter && typeof props.dataFormatter === 'function') ? props.dataFormatter(sum) : (props.tickData[props.tickValuesX.indexOf(props.datum)] || sum)
